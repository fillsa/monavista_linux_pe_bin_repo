...
static variable Compile_Last_Compile_Cmd = "";
public variable Compile_Process_Id = -1;

static define compile_set_status_line (state)
{
   set_mode ("compile: " + state, 0);
}

static define compile_signal_handler (pid, flags, status)
{
...
static define compile_start_process (cmd)
{
