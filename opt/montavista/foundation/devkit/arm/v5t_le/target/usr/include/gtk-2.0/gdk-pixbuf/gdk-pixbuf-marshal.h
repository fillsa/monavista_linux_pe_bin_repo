...
/* VOID:INT,INT,INT,INT (../../gdk-pixbuf/gdk-pixbuf-marshal.list:26) */
...
/* VOID:POINTER (../../gdk-pixbuf/gdk-pixbuf-marshal.list:27) */
#define _gdk_pixbuf_marshal_VOID__POINTER	g_cclosure_marshal_VOID__POINTER

/* VOID:INT,INT (../../gdk-pixbuf/gdk-pixbuf-marshal.list:28) */
