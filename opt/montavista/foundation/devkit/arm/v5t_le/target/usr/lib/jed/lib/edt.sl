...
%%
%%  To load this, put the line:  ()=evalfile("edt.sl");
...
static variable Edt_Keypad_State;
static define application_keypad_mode (state)
{
...
static variable edt_dir; edt_dir = 1;
