...
static void find_first_thread (void);
...
thread_db_create_event (CORE_ADDR where)
{
  ...
  process = inferior_target_data (current_inferior);
...
find_first_thread (void)
{
  ...
  /* First update the PID in the threads list to be a TID.  */
...
thread_db_find_new_threads (void)
{
  ...
  /* This function is only called when we first initialize thread_db.
     First locate the initial thread.  */
  find_first_thread ();
