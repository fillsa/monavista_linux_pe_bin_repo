...
## Package name      : perl5
## Source directory  : .
## Configuration time: Wed Jun 30 13:01:28 PDT 2004
## Configured by     : source@mvista.com
## Target system     : Hard Hat Linux 
#
...
archlibexp='/usr/lib/perl5/5.8.4'
archname='arm-linux'
cc='arm_v5t_le-gcc'
...
installarchlib='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/lib/perl/5.8.4'
installprivlib='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/lib/perl/5.8.4'
libpth='/lib /usr/lib'
...
ccname='arm_v5t_le-gcc'
ccsymbols='cpu=arm __GNUC_PATCHLEVEL__=2 __gnu_linux__=1 __GXX_ABI_VERSION=102 machine=arm __NO_INLINE__=1 __STDC_HOSTED__=1 system=posix __tune_arm__=1'
ccversion=''
cf_by='source'
cf_email='source@mvista.com'
cf_time='Wed Jun 30 13:01:28 PDT 2004'
charsize='1'
chgrp=''
chmod='chmod'
chown=''
...
cpp='arm_v5t_le-g++'
cpp_stuff='42'
cppccsymbols='__ELF__=1 __GNUC__=3 __GNUC_MINOR__=2 arm=1 __arm=1 __arm__=1 linux=1 __linux=1 __linux__=1 unix=1 __unix=1 __unix__=1'
cpplast='-'
cppminus='-'
cpprun='cc -E'
cppstdin='cc -E'
...
freetype='void'
from=':'
full_ar='arm_v5t_le-ar'
full_csh='/bin/csh'
full_sed='/bin/sed'
gccansipedantic=''
gccosandvers=''
gccversion='3.3.1 (MontaVista 3.3.1-3.0.9.0300452 2003-12-02)'
getgrent_r_proto='0'
getgrgid_r_proto='0'
getgrnam_r_proto='0'
...
gidsize='4'
gidtype='gid_t'
glibpth='/usr/shlib  /lib /usr/lib /usr/lib/v5t_le /lib/v5t_le /usr/ccs/lib /usr/ucblib /usr/local/lib '
gmake='gmake'
gmtime_r_proto='0'
...
incpath=''
inews=''
installbin='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/bin'
installhtml1dir=''
installhtml3dir=''
installman1dir='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/share/man/man1'
installman3dir='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/share/man/man3'
installprefix='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/'
installprefixexp='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/'
installscript='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/bin'
installsitearch='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/local/lib/perl/5.8.4'
installsitebin='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/bin'
installsitehtml1dir=''
installsitehtml3dir=''
installsitelib='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/local/share/perl/5.8.4'
installsiteman1dir='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/share/man/man1'
installsiteman3dir='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/share/man/man3'
installsitescript='/var/tmp/perl-arm_v5t_le-root/opt/montavista/foundation/devkit/arm/v5t_le/target/usr/bin'
...
libperl='libperl.a'
libsdirs=''
libsfiles=' libgdbm.so libdb.so libdl.so libm.so libc.so libcrypt.so'
libsfound=''
...
sitehtml3dir=''
sitehtml3direxp=''
sitelib='/usr/local/lib/perl5/site_perl/5.8.4'
...
uvuformat='"lu"'
uvxformat='"lx"'
vendorarch='/usr/lib/perl'
vendorarchexp='/usr/lib/perl'
vendorbin='/usr/bin'
...
vendorlib_stem='/usr/share/perl5'
...
vi=''
voidflags='15'
xlibpth='/usr/lib/v5t_le /lib/v5t_le'
yacc='/usr/bin/byacc'
yaccflags=''
zcat=''
zip='zip'
