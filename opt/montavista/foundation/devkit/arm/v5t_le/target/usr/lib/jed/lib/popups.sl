...
#ifndef VMS
static define add_files_popup_with_callback (parent, popup, dir, pattern, fun)
{
   variable files;
   variable i;
...
static define browse_docs_callback (file)
{
...
#ifndef VMS
menu_append_separator ($1);
static variable Gui_Jed;
static define set_gui_color_scheme (file)
{
...
static define about_jed (unused)
{
...
define add_files_popup_with_callback();
#endif
