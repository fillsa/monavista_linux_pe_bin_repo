...
/* BOOL:NONE (../../gtk/gtkmarshal.list:1) */
...
/* BOOL:POINTER (../../gtk/gtkmarshal.list:2) */
...
/* BOOL:POINTER,POINTER,INT,INT (../../gtk/gtkmarshal.list:3) */
...
/* BOOL:POINTER,INT,INT (../../gtk/gtkmarshal.list:4) */
...
/* BOOL:POINTER,INT,INT,UINT (../../gtk/gtkmarshal.list:5) */
...
/* BOOL:POINTER,STRING,STRING,POINTER (../../gtk/gtkmarshal.list:6) */
...
/* ENUM:ENUM (../../gtk/gtkmarshal.list:7) */
...
/* INT:POINTER (../../gtk/gtkmarshal.list:8) */
...
/* INT:POINTER,CHAR,CHAR (../../gtk/gtkmarshal.list:9) */
...
/* NONE:ENUM,FLOAT,BOOL (../../gtk/gtkmarshal.list:14) */
...
/* NONE:INT,INT,POINTER (../../gtk/gtkmarshal.list:17) */
...
/* NONE:POINTER,INT (../../gtk/gtkmarshal.list:21) */
...
/* NONE:POINTER,POINTER (../../gtk/gtkmarshal.list:22) */
...
/* NONE:POINTER,POINTER,POINTER (../../gtk/gtkmarshal.list:23) */
...
/* NONE:POINTER,STRING,STRING (../../gtk/gtkmarshal.list:24) */
...
/* NONE:POINTER,UINT (../../gtk/gtkmarshal.list:25) */
...
/* NONE:POINTER,UINT,ENUM (../../gtk/gtkmarshal.list:26) */
...
/* NONE:POINTER,POINTER,UINT,UINT (../../gtk/gtkmarshal.list:27) */
...
/* NONE:POINTER,INT,INT,POINTER,UINT,UINT (../../gtk/gtkmarshal.list:28) */
...
/* NONE:POINTER,UINT,UINT (../../gtk/gtkmarshal.list:29) */
...
/* NONE:POINTER,UINT,UINT (../../gtk/gtkmarshal.list:30) */

/* NONE:STRING (../../gtk/gtkmarshal.list:31) */
#define gtk_marshal_VOID__STRING	g_cclosure_marshal_VOID__STRING
#define gtk_marshal_NONE__STRING	gtk_marshal_VOID__STRING

/* NONE:STRING,INT,POINTER (../../gtk/gtkmarshal.list:32) */
...
/* NONE:UINT,POINTER,UINT,UINT,ENUM (../../gtk/gtkmarshal.list:35) */
...
/* NONE:UINT,STRING (../../gtk/gtkmarshal.list:36) */
