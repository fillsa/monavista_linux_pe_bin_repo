...
% 
static define mousex_init_display_hook ()
{
...
static define mousex_reset_display_hook ()
{
...
static define mousex_menu (x, y)
{
   call ("select_menubar");
}

static define mousex_report (status)
{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% service functions
static define mouse_next_buffer ()
{
...
static define mouse_goto (moveto)
{
   if (moveto)
     pop_mark_0 ();
