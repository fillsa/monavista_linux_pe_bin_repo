...
TCL_EXTRA_CFLAGS=' -fno-inline'

# Base command to use for combining object files into a shared library:
TCL_SHLIB_LD='arm_v5t_le-gcc   -shared'
...
TCL_INC_DIR='/usr/include/tcl-private/generic'
