...
/* Remove all breakpoints from memory, without affecting our state.
   Used when the inferior forks.  */

void
disable_all_breakpoints (void)
{
  struct breakpoint *bp = breakpoints;
...
/* Re-enable all breakpoints, without affecting our state.  Used after
   the inferior vforks.  */

void
enable_all_breakpoints (void)
{
  struct breakpoint *bp = breakpoints;
